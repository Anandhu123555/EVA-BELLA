...
def a(client, message):
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    m = message.reply('<b>Searching Song... Please Wait...\n It will Take Some Time</b>')
    ...
    try:
        ...
        m.edit('**An Error Occured. Please Report This To @Anandhukuttu !!**')
        print(e)
    try:
